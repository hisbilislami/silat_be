...
use Auth;
use App\Models\Master_service_prerequisite;
use Symfony\Component\HttpFoundation\Response;
use Illuminate\Validation\ValidationException;

class M_service_prerequisiteController extends Controller
{
    protected $model;
    public function __construct()
    {
        $this->model = new Master_service_prerequisite();
    }
    ...
    public function insert(Request $request)
    {
        try {
            ...
            $request->validate(
                [
                    '*.m_service_id' => 'required|integer|exists:m_service,id',
    ...
    public function update(Request $request)
    {
        try {
            ...
            $request->validate(
                [
                    '*.id' => 'required|integer|exists:m_service_prerequisite,id',
                    '*.m_service_id' => 'required|integer|exists:m_service,id',
                    '*.m_prerequisite_id' => 'required|integer|exists:m_prerequisite,id',
                    '*.type' => 'required|string',
                ]
